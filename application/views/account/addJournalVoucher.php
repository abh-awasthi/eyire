                                    ...
                                    <div class="col-md-6 form-group form-float">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control datepicker" value="<?php echo date('d-m-Y');?>" name="voucher_date" min="<?php echo date('d-m-Y', strtotime('-31 days'))?>" max="<?php echo date('d-m-Y');?>" placeholder="Enter Date" id="voucher_date" required aria-required="true">
                                            </div>
                                        </div>
